#!/usr/bin/env python3
"""Script to reprocess a single file through the AI summarizer."""
...
def reprocess_file(file_name: str):
    """Reprocess a single file through the AI summarizer."""
    ...
    print(f"\nProcessing file through AI summarizer...")
    ...
    new_summary_file = Path(f"/workspaces/amy-project/hansman_results/summaries/{Path(file_name).stem}_summary_fixed.json")
    ...
    summary_data['processed_at'] = '2025-05-19T15:30:00'
