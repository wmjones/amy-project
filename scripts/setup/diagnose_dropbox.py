...
def diagnose_connection():
    ...
    print(f"   DROPBOX_APP_SECRET: {'✓ Found' if app_secret else '✗ Missing'} ({app_secret[:5]}...)")
    print(f"   DROPBOX_REFRESH_TOKEN: {'✓ Found' if refresh_token else '✗ Missing'} ({refresh_token[:20]}...)")
    ...
    print(f"   https://www.dropbox.com/oauth2/authorize?response_type=code&client_id={app_key}&token_access_type=offline")
