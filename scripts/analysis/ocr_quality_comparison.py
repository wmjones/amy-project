...
def compare_ocr_quality(original_path, processed_path):
    ...
    if processed_metrics['avg_word_length'] > 2 and processed_metrics['avg_word_length'] < 10:
...
if __name__ == "__main__":
    ...
    original_ocr = "/workspaces/amy-project/hansman_results/ocr_results/100_4247_ocr.txt"
