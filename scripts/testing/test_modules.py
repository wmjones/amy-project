...
def test_imports():
    ...
    modules_to_test = [
        ...
        ("Dropbox Accessor", "from src.file_access.dropbox_accessor import DropboxAccessor"),
        ...
        ("Metadata Extractor", "from src.metadata_extraction.extractor import MetadataExtractor"),
        ("Organization Engine", "from src.organization_logic.engine import OrganizationEngine"),
