...
class TestMetadataIntegrationBridge(unittest.TestCase):
    ...
    def test_integrate_pipeline_result_with_existing(self):
        ...
        self.assertGreaterEqual(integrated.confidence_score, self.existing_metadata.confidence_score)
    ...
    def test_conflict_detection(self):
        ...
        date_conflict = next((c for c in conflicts if c.field_name == "document_date"), None)
    ...
    def test_convert_ai_to_document_metadata(self):
        ...
        doc_metadata = self.bridge._convert_ai_to_document_metadata(self.pipeline_result)
    ...
    def test_merge_metadata(self):
        ...
        merged, conflicts = self.bridge._merge_metadata(
            ...
            ai_metadata,
            self.ai_summary.confidence_score
        )
    ...
    def test_create_enriched_metadata(self):
        ...
        report = self.bridge.create_enriched_metadata(
            results,
        ...
        self.assertEqual(report["enrichment_statistics"]["ai_classification_success"], 1)
    ...
    def test_audit_trail(self):
        ...
        # Test filtering
        filtered_events = self.bridge.get_audit_trail(
            event_type="metadata_created"
        )
        self.assertTrue(all(e["event_type"] == "metadata_created" for e in filtered_events))
    
    def test_export_audit_trail(self):
        """Test audit trail export."""
        # Add some events
        self.bridge._log_audit_event(
            "test_event",
            "test_file.txt",
            {"test": "data"}
        )
