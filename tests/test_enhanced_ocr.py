...
class TestEnhancedOCRProcessor:
    ...
    def test_identify_problematic_regions(self, enhanced_ocr_processor):
        ...
        unusual_char_regions = [r for r in regions if r.issue_type == 'unusual_characters']
...
class TestDataClasses:
    ...
    def test_enhanced_ocr_result_serialization(self):
        ...
        result = EnhancedOCRResult(
            ...
            overall_confidence=90.0,
            word_confidences=[
                WordConfidence('Test', 90, (0, 0, 30, 20))
            ],
            character_confidences=[
                CharacterConfidence('T', 92, (0, 0, 10, 20))
            ],
            lines=[
                LineData(
                    text='Test',
