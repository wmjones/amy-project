...
from src.preprocessing.segmenter import DocumentSegmenter, DocumentRegion, DocumentRegionType
    ...
    def test_process_batch(self, temp_image_file, temp_output_dir):
        ...
        try:
            ...
            for path in test_images:
                ...
                assert 'error' not in results[path] or results[path].get('errors', []) == []
        finally:
...
class TestPipelineConfig:
    ...
    def test_config_serialization(self, temp_output_dir):
        ...
        assert loaded_config.enhancement.contrast_factor == config.enhancement.contrast_factor
        ...
        assert loaded_config_json.enhancement.contrast_factor == config.enhancement.contrast_factor
