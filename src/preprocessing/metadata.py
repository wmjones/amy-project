...
class MetadataProfile:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'MetadataProfile':
        ...
        quality_metrics = QualityMetrics(**data['quality_metrics']) if data.get('quality_metrics') else None
...
def create_metadata_profile(image_path: str, document_id: Optional[str] = None) -> MetadataProfile:
