...
class ClaudeClient:
    ...
    def analyze_document(
        ...
        for attempt in range(self.retry_attempts):
            try:
                response = self._make_api_call(prompt, system)
    ...
    def analyze_batch(
        ...
        Args:
            documents: List of documents with 'content', 'file_name', 'file_type'
    ...
    def _make_api_call(self, prompt: str, system: str) -> Any:
...
Format the response as structured JSON."""
    ...
    def _calculate_wait_time(self, attempt: int, error: RateLimitError) -> float:
        ...
        """
        # Check if error has retry_after header
    ...
    def validate_connection(self) -> bool:
        """Validate API connection with a simple test.
