...
class MetricsCollector:
    ...
    def get_current_metrics(
        ...
        with self.lock:
            ...
            if elapsed_time > 0:
                throughput = (self.cumulative_metrics['total_processed'] / elapsed_time) * 60
            else:
                throughput = 0.0
...
class MonitoringDashboard:
    ...
    def _check_alerts(self, metrics: LiveMetrics):
        ...
        # Check throughput
        if (metrics.files_processed > 10 and  # Only after processing some files
            metrics.current_throughput < self.alert_thresholds['throughput_min']):
            new_alerts.append({
                'type': 'low_throughput',
                'severity': 'medium',
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        if latest_metrics.files_pending > 0 and latest_metrics.current_throughput > 0:
            eta_minutes = latest_metrics.files_pending / latest_metrics.current_throughput
    ...
    def _calculate_trend(self, metric_name: str) -> str:
        ...
        change_percentage = ((avg_second_half - avg_first_half) / avg_first_half * 100) if avg_first_half else 0
