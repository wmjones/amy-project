    ...
    if system == "Linux":
        ...
        try:
            ...
            subprocess.run(['sudo', 'apt-get', 'install', '-y', 
                           'tesseract-ocr', 'tesseract-ocr-eng'], check=True)
...
def verify_tesseract():
    ...
    try:
        ...
        result = subprocess.run(['tesseract', str(test_image_path), 'stdout'],
                              capture_output=True, text=True)
...
def main():
    ...
    print("\n=== Setup Complete ===")
    print("Tesseract OCR is ready for the Hansman Syracuse Collection proof of concept!")
