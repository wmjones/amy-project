...
def create_architecture_diagram():
    ...
    ax.text(
        1.5, 3.25, "SQLite/JSON", ha="center", va="center", fontsize=10, color="white"
    )

    # Add data flow legend
    legend_elements = [
        mpatches.Rectangle(
            (0, 0), 1, 1, facecolor=colors["input"], label="Input Sources"
        ),
        mpatches.Rectangle(
            (0, 0), 1, 1, facecolor=colors["processing"], label="Processing"
        ),
        mpatches.Rectangle((0, 0), 1, 1, facecolor=colors["ai"], label="AI Services"),
        mpatches.Rectangle(
            (0, 0), 1, 1, facecolor=colors["integration"], label="Integration"
        ),
...
def create_flow_diagram():
    ...
    ax.text(
        6,
        7.5,
        "Hansman Syracuse Collection Processing Flow",
        ha="center",
        va="center",
        fontsize=16,
        fontweight="bold",
    ...
    ax.text(
        0.5,
        0.5,
        "Processing: 400+ files | Time: 4-7 hours | Cost: $6.60",
        ha="left",
        va="center",
        fontsize=12,
        style="italic",
